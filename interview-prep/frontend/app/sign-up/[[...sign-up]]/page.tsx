    ...
    <div className="flex min-h-[80vh] items-center justify-center px-4">
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.28 }}
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-sm text-[#9B99B8]">Start your interview prep journey today</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1">
            <label className="text-sm text-[#9B99B8]">Name</label>
            <input className="input-base w-full" placeholder="Your name"
        ...
        <p className="text-center text-sm text-[#9B99B8]">
          ...
          <Link href="/sign-in" className="text-indigo-300 hover:underline">Sign in</Link>
        </p>
      </motion.div>
    </div>
  );
